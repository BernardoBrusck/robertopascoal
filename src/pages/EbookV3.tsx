...
const Block01 = () => {
  ...
  useEffect(() => {
    ...
    tl.to({}, { duration: hold });
    tl.fromTo(p2Ref.current, { opacity: 1, y: 0 }, { opacity: 0, y: -40, duration: dur, ease: 'power2.in' });
    ...
    <section ref={containerRef} className="bg-white relative min-h-[100vh] flex flex-col items-center justify-center overflow-hidden border-b border-gray-100">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-6 lg:px-12 text-center pointer-events-none">
        ...
        <div ref={p2Ref} className="absolute inset-0 flex flex-col items-center justify-center max-w-4xl mx-auto opacity-0">
           <span className="text-3xl md:text-5xl font-light text-black tracking-tight leading-tight text-balance">
             E o que você <span className="font-serif italic font-medium">carrega escondido</span><br/> na sua mochila?
           </span>
        </div>

        {/* Frase 3 (P3) */}
        <div ref={p3Ref} className="absolute inset-0 flex flex-col items-center justify-center max-w-4xl mx-auto opacity-0">
           <span className="text-3xl md:text-5xl lg:text-6xl font-light text-black tracking-tight leading-[1.1] text-balance">
             Um momento para <span className="font-medium italic">desacelerar</span><br/> e organizar a vida.
           </span>
        </div>
      </div>
      ...
      <div className="max-w-[1200px] w-full mx-auto flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-20 h-full">
        ...
        <div className="w-full md:w-1/2 max-w-[420px] aspect-[4/5] relative overflow-hidden shrink-0 mt-8 md:mt-0 rounded-2xl">
          <div ref={imgBoxRef} className="absolute inset-0 w-full h-full">
            <img src="/image/retrato-3-opt.webp" alt="Roberto Vertical" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
          </div>
        </div>
...
export default function EbookV3() {
  return (
